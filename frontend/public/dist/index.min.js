...
/***/ "./src/client/animations/dancing circles/classes/AudioHandler.ts":
/*!***********************************************************************!*\
  !*** ./src/client/animations/dancing circles/classes/AudioHandler.ts ***!
  \***********************************************************************/
...
/***/ "./src/client/animations/dancing circles/classes/Circle.ts":
/*!*****************************************************************!*\
  !*** ./src/client/animations/dancing circles/classes/Circle.ts ***!
  \*****************************************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const random_1 = __webpack_require__(/*! ../../../utils/random */ "./src/client/utils/random.ts");
const lerp_1 = __importDefault(__webpack_require__(/*! ../../../utils/lerp */ "./src/client/utils/lerp.ts"));
const ColorHandler_1 = __importDefault(__webpack_require__(/*! ./ColorHandler */ "./src/client/animations/dancing circles/classes/ColorHandler.ts"));
class Circle {
    constructor() {
        this.baseR = this.getBaseR();
        this.currentR = this.baseR;
        this.targetR = this.baseR;
        this.x = (0, random_1.getRandomX)(this.baseR, Circle.gap);
        this.y = (0, random_1.getRandomY)(this.baseR, Circle.gap);
        this.targetX = (0, random_1.getRandomX)(this.baseR, Circle.gap);
        this.targetY = (0, random_1.getRandomY)(this.baseR, Circle.gap);
        this.color = ColorHandler_1.default.getRandomColor(Circle.minS, Circle.maxS, Circle.minL, Circle.maxL, true);
        this.targetColor = ColorHandler_1.default.getRandomColor(Circle.minS, Circle.maxS, Circle.minL, Circle.maxL, true);
        this.startAngle = 0;
    ...
    convColor(isTColor, isRtoH) {
        ...
        const convertedColor = isRtoH ? ColorHandler_1.default.convertRGBtoHSL(colorToConvert) : ColorHandler_1.default.convertHSLStrToRGBStr(colorToConvert);
        if (isTColor) {
    ...
    lerpColor() {
        const t = .03;
        this.color = ColorHandler_1.default.lerpColor(this.color, this.targetColor, t);
    }
    lerpPosition(isX) {
        const t = .01;
        const axis = isX ? this.x : this.y;
        const tAxis = isX ? this.targetX : this.targetY;
        const position = (0, lerp_1.default)(axis, tAxis, t);
        if (isX) {
            this.x = position;
        }
        else {
    ...
    lerpRadius() {
        const t = .2;
        this.currentR = (0, lerp_1.default)(this.currentR, this.targetR, t);
    }
}
Circle.minS = 95;
Circle.maxS = 100;
...
/***/ "./src/client/animations/dancing circles/classes/ColorHandler.ts":
/*!***********************************************************************!*\
  !*** ./src/client/animations/dancing circles/classes/ColorHandler.ts ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
class ColorHandler {
    ...
    static getRandomColor(minS = 0, maxS = 100, minL = 0, maxL = 100, isHsl = true) {
        ...
        const s = (0, random_1.getRandomInt)(minS, maxS);
        const l = (0, random_1.getRandomInt)(minL, maxL);
...
/***/ "./src/client/animations/dancing circles/danceCircles.ts":
/*!***************************************************************!*\
  !*** ./src/client/animations/dancing circles/danceCircles.ts ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const constants_1 = __webpack_require__(/*! ../../utils/constants */ "./src/client/utils/constants.ts");
const random_1 = __webpack_require__(/*! ../../utils/random */ "./src/client/utils/random.ts");
const ColorHandler_1 = __importDefault(__webpack_require__(/*! ./classes/ColorHandler */ "./src/client/animations/dancing circles/classes/ColorHandler.ts"));
const Circle_1 = __importDefault(__webpack_require__(/*! ./classes/Circle */ "./src/client/animations/dancing circles/classes/Circle.ts"));
const AudioHandler_1 = __importDefault(__webpack_require__(/*! ./classes/AudioHandler */ "./src/client/animations/dancing circles/classes/AudioHandler.ts"));
function danceCircles() {
    ...
    const numCircs = 2;
    // // Audio Handling
    AudioHandler_1.default.processAudio(fileInput, uploadButton);
    ...
    const load = () => {
        stop = false;
        canvas.style.backgroundColor = ColorHandler_1.default.getRandomColor(canvasMinS, canvasMaxS, canvasMinL, canvasMaxL, true);
        canvasBgColor = ColorHandler_1.default.convertRGBtoHSL(canvas.style.backgroundColor);
        canvasTargetColor = ColorHandler_1.default.getRandomColor(canvasMinS, canvasMaxS, canvasMinL, canvasMaxL, true);
        Circle_1.default.startingBaseR = 50;
        Circle_1.default.prevR = 8;
        Circle_1.default.circles = [];
        for (let i = 0; i < Circle_1.default.circlesLength; i++) {
            new Circle_1.default();
        }
        // Sort circles in order of increasing radius
        Circle_1.default.circles.sort((a, b) => b.currentR - a.currentR);
    };
    ...
    function update(numCircs) {
        ...
        const randomIndexArr = (0, random_1.getRandomIndexArr)(Circle_1.default.circlesLength);
        for (let i = 0; i < numCircs; i++) {
            // Get circle at random index
            const circle = Circle_1.default.circles[randomIndexArr[i]];
            circle.targetX = (0, random_1.getRandomX)(circle.currentR, Circle_1.default.gap);
            circle.targetY = (0, random_1.getRandomY)(circle.currentR, Circle_1.default.gap);
            if (!AudioHandler_1.default.playing) {
                circle.targetR = circle.baseR;
                // Update two circles' colors at a time based on frequencies from input audio
                circle.targetColor = ColorHandler_1.default.getRandomColor(Circle_1.default.minS, Circle_1.default.maxS, Circle_1.default.minL, Circle_1.default.maxL, true);
            }
        }
    }
    // Color adjust
        ...
        if (AudioHandler_1.default.playing) {
            ...
            if (colorTimer >= colorInterval) {
                ...
                for (let i = 0; i < Circle_1.default.circlesLength; i++) {
                    // Get circle at random index
                    const circle = Circle_1.default.circles[randomIndexArr[i]];
                    circle.targetColor = ColorHandler_1.default.convertHertzToHSL(Math.round(AudioHandler_1.default.pitch), Circle_1.default.minS, Circle_1.default.maxS, Circle_1.default.minL, Circle_1.default.maxL);
                }
                colorTimer = 0;
            }
            else {
            ...
            const volumePercentage = AudioHandler_1.default.getVolumePercentage(AudioHandler_1.default.volume);
            if (AudioHandler_1.default.volume != -Infinity) {
                const ajdust = 1 + (volumePercentage * .02);
                if (increaseRTimer >= adjustRInterval) {
                    Circle_1.default.circles.forEach((circle, index) => {
                        if (even) {
                            if (index % 2 == 0)
    ...
    const draw = () => {
        ...
        canvas.style.backgroundColor = ColorHandler_1.default.lerpColor(canvasBgColor, canvasTargetColor, 0.02);
        canvasBgColor = ColorHandler_1.default.convertRGBtoHSL(canvas.style.backgroundColor);
        // Draw circles
        Circle_1.default.circles.forEach((circle) => {
            ...
            ctx.beginPath();
            ctx.fillStyle = ColorHandler_1.default.convertHSLtoHSLA(circle.color, .7);
...
/***/ "./src/client/components/Error404.ts":
/*!*******************************************!*\
  !*** ./src/client/components/Error404.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/client/components/Games.ts":
/*!****************************************!*\
  !*** ./src/client/components/Games.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/client/components/Register.ts":
/*!*******************************************!*\
  !*** ./src/client/components/Register.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/client/components/SocialMedia.ts":
/*!**********************************************!*\
  !*** ./src/client/components/SocialMedia.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const getUserData_1 = __importDefault(__webpack_require__(/*! ../utils/getUserData */ "./src/client/utils/getUserData.ts"));
function component() {
    const user = function (id) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield (0, getUserData_1.default)();
            const numericId = parseInt(id, 10);
            if (isNaN(numericId)) {
                throw new Error('Invalid id');
            }
            const userData = data.find((user) => user.user_id === numericId);
            if (!userData) {
    ...
    const render = function (params) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userData = yield user(params.id);
                return /*html*/ `
                <div>
...
/***/ "./src/client/components/animations/DanceCircles.ts":
/*!**********************************************************!*\
  !*** ./src/client/components/animations/DanceCircles.ts ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const danceCircles_1 = __importDefault(__webpack_require__(/*! ../../animations/dancing circles/danceCircles */ "./src/client/animations/dancing circles/danceCircles.ts"));
function component() {
    const render = function () {
        return /*html*/ `
...
/***/ "./src/client/components/games/P4Vega.ts":
/*!***********************************************!*\
  !*** ./src/client/components/games/P4Vega.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const p4_Vega_1 = __importDefault(__webpack_require__(/*! ../../games/p4-Vega/p4-Vega */ "./src/client/games/p4-Vega/p4-Vega.ts"));
function component() {
    const render = function () {
        return /*html*/ `
...
/***/ "./src/client/events/EventListenerManager.ts":
/*!***************************************************!*\
  !*** ./src/client/events/EventListenerManager.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
class EventListenerManager {
    ...
    static initSidebarToggle() {
        ...
        const sideBarButton = document.querySelector('.menu-btn');
...
exports["default"] = EventListenerManager;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initializeObserver = exports.stopAnimation = void 0;
                    ...
                    if (mutation.target === content && node.id) {
                        ...
                        switch (componentId) {
                            case "dancing-circles":
                                (0, exports.stopAnimation)(window.dcAnimationID);
                                break;
                            case "p4-vega":
                                (0, exports.stopAnimation)(window.p4AnimationID);
                                break;
                        }
...
/***/ "./src/client/games/classes/Entity.ts":
/*!********************************************!*\
  !*** ./src/client/games/classes/Entity.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/client/games/p4-Vega/classes/BlackHole.ts":
/*!*******************************************************!*\
  !*** ./src/client/games/p4-Vega/classes/BlackHole.ts ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const constants_1 = __webpack_require__(/*! ../../../utils/constants */ "./src/client/utils/constants.ts");
const random_1 = __webpack_require__(/*! ../../../utils/random */ "./src/client/utils/random.ts");
const checkCollision_1 = __importDefault(__webpack_require__(/*! ../../../utils/checkCollision */ "./src/client/utils/checkCollision.ts"));
const Entity_1 = __importDefault(__webpack_require__(/*! ../../classes/Entity */ "./src/client/games/classes/Entity.ts"));
class BlackHole extends Entity_1.default {
    constructor() {
        super(BlackHole.getRandomSprite(), 50);
        this.hue = (0, random_1.getRandomInt)(0, 360);
        this.minDistance = 200;
        this.width = 90;
        this.height = 90;
        this.x = (0, random_1.getRandomX)(this.sprite.width);
        this.y = (0, random_1.getRandomY)(this.sprite.height);
        this.free = false;
    ...
    determineDirection() {
        if ((0, random_1.getRandomBoolean)()) {
    ...
    static getRandomSprite() {
        ...
        return sprites[(0, random_1.getRandomInt)(0, 2)];
    }
    update(deltaTime, p4, gameLive) {
        super.update(deltaTime);
        if ((0, checkCollision_1.default)(p4, this)) {
            gameLive = false;
        }
        this.y += this.vY;
        this.x += this.vX;
        if (this.y + this.height >= constants_1.CANVAS_HEIGHT || this.y <= 0) {
            this.vY *= -1;
            this.hue = (0, random_1.getRandomInt)(0, 360);
        }
        if (this.x + this.width >= constants_1.CANVAS_WIDTH || this.x <= 0) {
            this.vX *= -1;
            this.hue = (0, random_1.getRandomInt)(0, 360);
        }
        return gameLive;
...
/***/ "./src/client/games/p4-Vega/classes/P4.ts":
/*!************************************************!*\
  !*** ./src/client/games/p4-Vega/classes/P4.ts ***!
  \************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const constants_1 = __webpack_require__(/*! ../../../utils/constants */ "./src/client/utils/constants.ts");
const Entity_1 = __importDefault(__webpack_require__(/*! ../../classes/Entity */ "./src/client/games/classes/Entity.ts"));
class P4 extends Entity_1.default {
    constructor() {
        super("p4");
        this.startX = Entity_1.default.gap;
        this.startY = constants_1.CANVAS_HEIGHT * .5;
        this.speed = 10;
        this.width = 70;
        this.height = 66;
        this.x = this.startX;
    ...
    update(deltaTime) {
        ...
        // World bounds
        if (this.x + this.width * .8 > constants_1.CANVAS_WIDTH - Entity_1.default.gap) {
            this.x -= this.speed;
        }
        if (this.x < 0) {
            this.x += this.speed;
        }
        if (this.y + this.height * .8 > constants_1.CANVAS_HEIGHT - Entity_1.default.gap) {
            this.y -= this.speed;
        }
        if (this.y < 0) {
            this.y += this.speed;
...
/***/ "./src/client/games/p4-Vega/classes/Sky.ts":
/*!*************************************************!*\
  !*** ./src/client/games/p4-Vega/classes/Sky.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const Star_1 = __importDefault(__webpack_require__(/*! ./Star */ "./src/client/games/p4-Vega/classes/Star.ts"));
class Sky {
    constructor(canvas) {
        this.stars = [];
    ...
    createStars() {
        for (let i = 0; i < this.numberOfStars; i++) {
            this.stars.push(new Star_1.default(this));
        }
    }
}
exports["default"] = Sky;
...
/***/ "./src/client/games/p4-Vega/classes/Star.ts":
/*!**************************************************!*\
  !*** ./src/client/games/p4-Vega/classes/Star.ts ***!
  \**************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/client/games/p4-Vega/classes/Water.ts":
/*!***************************************************!*\
  !*** ./src/client/games/p4-Vega/classes/Water.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const random_1 = __webpack_require__(/*! ../../../utils/random */ "./src/client/utils/random.ts");
const checkCollision_1 = __importDefault(__webpack_require__(/*! ../../../utils/checkCollision */ "./src/client/utils/checkCollision.ts"));
const BlackHole_1 = __importDefault(__webpack_require__(/*! ./BlackHole */ "./src/client/games/p4-Vega/classes/BlackHole.ts"));
const Entity_1 = __importDefault(__webpack_require__(/*! ../../classes/Entity */ "./src/client/games/classes/Entity.ts"));
class Water extends Entity_1.default {
    ;
    constructor() {
        super("water", 50);
        this.width = 28;
        this.height = 46;
        this.x = constants_1.CANVAS_WIDTH - this.sprite.width - Entity_1.default.gap;
        this.y = constants_1.CANVAS_HEIGHT * .5;
    }
    totalFrames() {
        return 5;
    }
    update(deltaTime, p4) {
        super.update(deltaTime);
        if ((0, checkCollision_1.default)(p4, this)) {
            this.x = (0, random_1.getRandomX)(this.width + Entity_1.default.gap + this.gap);
            this.y = (0, random_1.getRandomY)(this.height + Entity_1.default.gap + this.gap);
            p4.totalWater += 10;
            BlackHole_1.default.release(p4);
        }
    }
}
...
/***/ "./src/client/games/p4-Vega/p4-Vega.ts":
/*!*********************************************!*\
  !*** ./src/client/games/p4-Vega/p4-Vega.ts ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const constants_1 = __webpack_require__(/*! ../../utils/constants */ "./src/client/utils/constants.ts");
const P4_1 = __importDefault(__webpack_require__(/*! ./classes/P4 */ "./src/client/games/p4-Vega/classes/P4.ts"));
const Water_1 = __importDefault(__webpack_require__(/*! ./classes/Water */ "./src/client/games/p4-Vega/classes/Water.ts"));
const BlackHole_1 = __importDefault(__webpack_require__(/*! ./classes/BlackHole */ "./src/client/games/p4-Vega/classes/BlackHole.ts"));
const Sky_1 = __importDefault(__webpack_require__(/*! ./classes/Sky */ "./src/client/games/p4-Vega/classes/Sky.ts"));
function p4Vega() {
    // Canvas
    ...
    const load = () => {
        gameLive = true;
        sky = new Sky_1.default(canvas);
        p4 = new P4_1.default();
        water = new Water_1.default();
        BlackHole_1.default.poolSize = 15;
        BlackHole_1.default.freeElements = 0;
        BlackHole_1.default.pool = new Array(BlackHole_1.default.poolSize).fill(0);
        for (let i = 0; i < BlackHole_1.default.poolSize; i++) {
            BlackHole_1.default.pool[i] = new BlackHole_1.default();
        }
        BlackHole_1.default.nextFree = BlackHole_1.default.pool[0];
        BlackHole_1.default.release(p4);
    };
    const update = () => {
        p4.update(deltaTime);
        water.update(deltaTime, p4);
        for (let i = 0; i < BlackHole_1.default.freeElements; i++) {
            const blackHole = BlackHole_1.default.pool[i];
            blackHole.free = true;
    ...
    const draw = () => {
        ...
        if (!gameLive) {
            ...
            ctx.fillText("GAME OVER", constants_1.CANVAS_WIDTH * .5, constants_1.CANVAS_HEIGHT * .5 - 20);
            ctx.fillStyle = "cyan";
            ctx.fillText("Total Water: " + p4.totalWater, constants_1.CANVAS_WIDTH * .5, constants_1.CANVAS_HEIGHT * .5 + 60);
            ctx.font = "30px Arial";
            ctx.fillText("Press space to try again", constants_1.CANVAS_WIDTH * .5, constants_1.CANVAS_HEIGHT * .5 + 100);
        }
    };
    deltaTime = 0;
    lastTime = 0;
...
exports["default"] = p4Vega;


/***/ }),

/***/ "./src/client/home/listUsers.ts":
/*!**************************************!*\
  !*** ./src/client/home/listUsers.ts ***!
  \**************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const page_1 = __importDefault(__webpack_require__(/*! page */ "./node_modules/page/page.js"));
const setUpRoutes_1 = __importDefault(__webpack_require__(/*! ./routes/setUpRoutes */ "./src/client/routes/setUpRoutes.ts"));
const initializeGlobals_1 = __importDefault(__webpack_require__(/*! ./utils/initializeGlobals */ "./src/client/utils/initializeGlobals.ts"));
const EventListenerManager_1 = __importDefault(__webpack_require__(/*! ./events/EventListenerManager */ "./src/client/events/EventListenerManager.ts"));
const eventManager_1 = __webpack_require__(/*! ./events/eventManager */ "./src/client/events/eventManager.ts");
// Initialize global variables
(0, initializeGlobals_1.default)();
// Define routes using Page.js
(0, setUpRoutes_1.default)(page_1.default);
// Start Alpine.js and Page.js
alpinejs_1.default.start();
page_1.default.start();
// Initialize event manager
(0, eventManager_1.initializeObserver)();
// Initialize event listeners
document.addEventListener('DOMContentLoaded', () => {
    EventListenerManager_1.default.init();
});


/***/ }),

/***/ "./src/client/register/create.ts":
/*!***************************************!*\
  !*** ./src/client/register/create.ts ***!
  \***************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
    ...
    return {
        ...
        createUser: function () {
            ...
            fetch('https://mickeyf-org-j7yuum4tiq-uc.a.run.app/api/users', {
                ...
                if (data.error) {
                    switch (data.error) {
                        case constants_1.INVALID_EMAIL:
                            sweetalert2_1.default.fire({
                                title: 'Invalid email',
                                icon: 'warning'
                            });
                            break;
                        case constants_1.INVALID_PASSWORD:
                            sweetalert2_1.default.fire({
                            ...
                            break;
                        case constants_1.EMPTY_FIELDS:
                            sweetalert2_1.default.fire({
                                title: 'Missing required fields',
                                icon: 'warning'
                            });
                            break;
                        case constants_1.DUPLICATE_USER:
                            sweetalert2_1.default.fire({
...
/***/ "./src/client/routes/setUpRoutes.ts":
/*!******************************************!*\
  !*** ./src/client/routes/setUpRoutes.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const loadComponent_1 = __webpack_require__(/*! ../utils/loadComponent */ "./src/client/utils/loadComponent.ts");
// The setUpRoutes function is used to set up the routes for the application.
const setUpRoutes = (page) => {
    page('/', () => (0, loadComponent_1.loadComponent)('/'));
    page('/user/signup', () => {
        document.body.className = 'registration-page';
        (0, loadComponent_1.loadComponent)('/user/signup');
    });
    page('/user/:id', ctx => (0, loadComponent_1.loadComponent)('/user/:id', { id: ctx.params.id }));
    page('/games', () => (0, loadComponent_1.loadComponent)('/games'));
    page('/animations', () => (0, loadComponent_1.loadComponent)('/animations'));
    page('/socialmedia', () => (0, loadComponent_1.loadComponent)('/socialmedia'));
    page('/dancing-circles', () => (0, loadComponent_1.loadComponent)('/dancing-circles'));
    page('/p4-Vega', () => (0, loadComponent_1.loadComponent)('/p4-Vega'));
    page('*', () => (0, loadComponent_1.loadComponent)('/error'));
};
...
/***/ "./src/client/utils/checkCollision.ts":
/*!********************************************!*\
  !*** ./src/client/utils/checkCollision.ts ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const Entity_1 = __importDefault(__webpack_require__(/*! ../games/classes/Entity */ "./src/client/games/classes/Entity.ts"));
// Check if two rectangles are colliding
function checkCollision(rect1, rect2) {
    return ((rect1.x + rect1.width - Entity_1.default.hitBoxAdjust > rect2.x) &&
        (rect1.x < rect2.x + rect2.width - Entity_1.default.hitBoxAdjust) &&
        (rect1.y + rect1.height - Entity_1.default.hitBoxAdjust > rect2.y) &&
        (rect1.y < rect2.y + rect2.height - Entity_1.default.hitBoxAdjust));
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DUPLICATE_USER = exports.EMPTY_FIELDS = exports.INVALID_PASSWORD = exports.INVALID_EMAIL = exports.CANVAS_HEIGHT = exports.CANVAS_WIDTH = void 0;
exports.CANVAS_WIDTH = 1920 * 1.2;
exports.CANVAS_HEIGHT = 1080 * 1.07;
exports.INVALID_EMAIL = "INVALID_EMAIL";
exports.INVALID_PASSWORD = "INVALID_PASSWORD";
exports.EMPTY_FIELDS = "EMPTY_FIELDS";
exports.DUPLICATE_USER = "DUPLICATE_USER";


/***/ }),

/***/ "./src/client/utils/getUserData.ts":
/*!*****************************************!*\
  !*** ./src/client/utils/getUserData.ts ***!
  \*****************************************/
...
/***/ "./src/client/utils/initializeGlobals.ts":
/*!***********************************************!*\
  !*** ./src/client/utils/initializeGlobals.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const create_1 = __importDefault(__webpack_require__(/*! ../register/create */ "./src/client/register/create.ts"));
const listUsers_1 = __importDefault(__webpack_require__(/*! ../home/listUsers */ "./src/client/home/listUsers.ts"));
const alpinejs_1 = __importDefault(__webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/module.esm.js"));
const page_1 = __importDefault(__webpack_require__(/*! page */ "./node_modules/page/page.js"));
// Global variables
const initializeGlobals = () => {
    window.page = page_1.default;
    window.Alpine = alpinejs_1.default;
    window.eventListeners = {};
    window.create = create_1.default;
    window.listUsers = listUsers_1.default;
};
exports["default"] = initializeGlobals;


/***/ }),

/***/ "./src/client/utils/lerp.ts":
/*!**********************************!*\
  !*** ./src/client/utils/lerp.ts ***!
  \**********************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/client/utils/loadComponent.ts":
/*!*******************************************!*\
  !*** ./src/client/utils/loadComponent.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const Home_1 = __importDefault(__webpack_require__(/*! ../components/Home */ "./src/client/components/Home.ts"));
const User_1 = __importDefault(__webpack_require__(/*! ../components/User */ "./src/client/components/User.ts"));
const Games_1 = __importDefault(__webpack_require__(/*! ../components/Games */ "./src/client/components/Games.ts"));
const Animations_1 = __importDefault(__webpack_require__(/*! ../components/Animations */ "./src/client/components/Animations.ts"));
const SocialMedia_1 = __importDefault(__webpack_require__(/*! ../components/SocialMedia */ "./src/client/components/SocialMedia.ts"));
const Register_1 = __importDefault(__webpack_require__(/*! ../components/Register */ "./src/client/components/Register.ts"));
const DanceCircles_1 = __importDefault(__webpack_require__(/*! ../components/animations/DanceCircles */ "./src/client/components/animations/DanceCircles.ts"));
const P4Vega_1 = __importDefault(__webpack_require__(/*! ../components/games/P4Vega */ "./src/client/components/games/P4Vega.ts"));
const Error404_1 = __importDefault(__webpack_require__(/*! ../components/Error404 */ "./src/client/components/Error404.ts"));
const routes = {
    "/": Home_1.default,
    "/user/signup": Register_1.default,
    "/user/:id": User_1.default,
    "/games": Games_1.default,
    "/animations": Animations_1.default,
    "/socialmedia": SocialMedia_1.default,
    "/dancing-circles": DanceCircles_1.default,
    "/p4-Vega": P4Vega_1.default,
    "/error": Error404_1.default
};
// Utility function to match dynamic routes
function matchRoute(requestedRoute) {
...
const loadComponent = (requestedRoute, params) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        ...
        content.innerHTML = yield component.render(params);
        (_a = component.action) === null || _a === void 0 ? void 0 : _a.call(component, params);
    }
    catch (error) {
        ...
        content.innerHTML = yield Error404_1.default.render(); // Render a full error component
    }
});
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getRandomIndexArr = exports.getRandomY = exports.getRandomX = exports.getRandomInt = exports.getRandomBoolean = void 0;
const constants_1 = __webpack_require__(/*! ./constants */ "./src/client/utils/constants.ts");
...
function getRandomX(width, gap = 0) {
    let x = (Math.random() * (constants_1.CANVAS_WIDTH - width + gap));
    if (x < width - gap) {
        x += width - x;
    }
    return x;
...
function getRandomY(width, gap = 0) {
    let y = (Math.random() * (constants_1.CANVAS_HEIGHT - width + gap));
    if (y < width - gap) {
        y += width - y;
    }
    return y;
...
exports.getRandomIndexArr = getRandomIndexArr;
