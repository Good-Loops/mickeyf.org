...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const methods_1 = __webpack_require__(/*! ../src/utils/methods */ "./src/utils/methods.ts");
function component() {
    const user = function (id) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield (0, methods_1.getUserData)();
...
/***/ "./components/animations/DanceCircles.ts":
/*!***********************************************!*\
  !*** ./components/animations/DanceCircles.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const methods_1 = __webpack_require__(/*! ../../../utils/methods */ "./src/utils/methods.ts");
...
function listUsers() {
    return {
        ...
        navigateToUser: function (event) {
            ...
            if (userId) {
                (0, page_1.default)(`/user/${userId}`); // Navigate using page.js
...
const page_1 = __importDefault(__webpack_require__(/*! page */ "./node_modules/page/page.js"));
const loadPage_1 = __webpack_require__(/*! ./utils/loadPage */ "./src/utils/loadPage.ts");
// Define routes using Page.js
(0, page_1.default)('/', () => (0, loadPage_1.loadComponent)('/'));
(0, page_1.default)('/user/signup', () => (0, loadPage_1.loadComponent)('/user/signup'));
(0, page_1.default)('/user/:id', ctx => (0, loadPage_1.loadComponent)('/user/:id', { id: ctx.params.id }));
(0, page_1.default)('/games', () => (0, loadPage_1.loadComponent)('/games'));
(0, page_1.default)('/animations', () => (0, loadPage_1.loadComponent)('/animations'));
(0, page_1.default)('/socialmedia', () => (0, loadPage_1.loadComponent)('/socialmedia'));
(0, page_1.default)('/dancing-circles', () => (0, loadPage_1.loadComponent)('/dancing-circles'));
(0, page_1.default)('/p4-vega', () => (0, loadPage_1.loadComponent)('/p4-vega'));
(0, page_1.default)('*', () => (0, loadPage_1.loadComponent)('/error'));
...
const Games_1 = __importDefault(__webpack_require__(/*! ../../components/Games */ "./components/Games.ts"));
const Animations_1 = __importDefault(__webpack_require__(/*! ../../components/Animations */ "./components/Animations.ts"));
const SocialMedia_1 = __importDefault(__webpack_require__(/*! ../../components/SocialMedia */ "./components/SocialMedia.ts"));
const Register_1 = __importDefault(__webpack_require__(/*! ../../components/Register */ "./components/Register.ts"));
const DanceCircles_1 = __importDefault(__webpack_require__(/*! ../../components/animations/DanceCircles */ "./components/animations/DanceCircles.ts"));
const P4Vega_1 = __importDefault(__webpack_require__(/*! ../../components/games/P4Vega */ "./components/games/P4Vega.ts"));
