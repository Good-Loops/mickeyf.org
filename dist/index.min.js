...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nfunction component() {\n    const render = function () {\n        return /*html*/ `\r\n            <h1>Error 404: Page not found</h1>   \r\n        `;\n    };\n    return {\n        render,\n    };\n}\nexports[\"default\"] = component();\n\n\n//# sourceURL=webpack://mickeyf.org/./pages/Error404.ts?");
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst Star_1 = __importDefault(__webpack_require__(/*! ./Star */ \"./src/games/p4-Vega/classes/Star.ts\"));\nclass Sky {\n    constructor(canvas) {\n        this.stars = [];\n        this.width = canvas.width;\n        this.height = canvas.height;\n        this.stars = [];\n        this.numberOfStars = 60;\n        this.createStars();\n    }\n    handleStars(context) {\n        this.stars.forEach((star) => {\n            star.draw(context);\n            star.update();\n        });\n    }\n    createStars() {\n        for (let i = 0; i < this.numberOfStars; i++) {\n            this.stars.push(new Star_1.default(this));\n        }\n    }\n}\nexports[\"default\"] = Sky;\n\n\n//# sourceURL=webpack://mickeyf.org/./src/games/p4-Vega/classes/Sky.ts?");
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst constants_1 = __webpack_require__(/*! ../../../helpers/constants */ \"./src/helpers/constants.ts\");\nconst methods_1 = __webpack_require__(/*! ../../../helpers/methods */ \"./src/helpers/methods.ts\");\nconst BlackHole_1 = __importDefault(__webpack_require__(/*! ./BlackHole */ \"./src/games/p4-Vega/classes/BlackHole.ts\"));\nconst Entity_1 = __importDefault(__webpack_require__(/*! ../../classes/Entity */ \"./src/games/classes/Entity.ts\"));\nclass Water extends Entity_1.default {\n    ;\n    constructor() {\n        super(\"water\", 50);\n        this.width = 28;\n        this.height = 46;\n        this.x = constants_1.CANVAS_WIDTH - this.sprite.width - Entity_1.default.gap;\n        this.y = constants_1.CANVAS_HEIGHT * .5;\n    }\n    totalFrames() {\n        return 5;\n    }\n    update(deltaTime, p4) {\n        super.update(deltaTime);\n        if ((0, methods_1.checkCollision)(p4, this)) {\n            this.x = (0, methods_1.getRandomX)(this.width + Entity_1.default.gap + this.gap);\n            this.y = (0, methods_1.getRandomY)(this.height + Entity_1.default.gap + this.gap);\n            p4.totalWater += 10;\n            BlackHole_1.default.release(p4);\n        }\n    }\n}\nexports[\"default\"] = Water;\n\n\n//# sourceURL=webpack://mickeyf.org/./src/games/p4-Vega/classes/Water.ts?");
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst Home_1 = __importDefault(__webpack_require__(/*! ../../pages/Home */ \"./pages/Home.ts\"));\nconst User_1 = __importDefault(__webpack_require__(/*! ../../pages/User */ \"./pages/User.ts\"));\nconst Games_1 = __importDefault(__webpack_require__(/*! ../../pages/Games */ \"./pages/Games.ts\"));\nconst Animations_1 = __importDefault(__webpack_require__(/*! ../../pages/Animations */ \"./pages/Animations.ts\"));\nconst SocialMedia_1 = __importDefault(__webpack_require__(/*! ../../pages/SocialMedia */ \"./pages/SocialMedia.ts\"));\nconst Register_1 = __importDefault(__webpack_require__(/*! ../../pages/Register */ \"./pages/Register.ts\"));\nconst DanceCircles_1 = __importDefault(__webpack_require__(/*! ../../pages/animations/DanceCircles */ \"./pages/animations/DanceCircles.ts\"));\nconst P4Vega_1 = __importDefault(__webpack_require__(/*! ../../pages/games/P4Vega */ \"./pages/games/P4Vega.ts\"));\nconst Error404_1 = __importDefault(__webpack_require__(/*! ../../pages/Error404 */ \"./pages/Error404.ts\"));\nconst routes = {\n    \"/\": Home_1.default,\n    \"/user/signup\": Register_1.default,\n    \"/user/:id\": User_1.default,\n    \"/games\": Games_1.default,\n    \"/animations\": Animations_1.default,\n    \"/socialmedia\": SocialMedia_1.default,\n    \"/dancing-circles\": DanceCircles_1.default,\n    \"/p4-Vega\": P4Vega_1.default,\n    \"/error\": Error404_1.default\n};\nconst loadPageHtml = function (component, placeholder, uri) {\n    return __awaiter(this, void 0, void 0, function* () {\n        var _a;\n        const content = document.querySelector(\"#content\");\n        const newUri = component + placeholder;\n        let componentHtml = (_a = routes[uri]) !== null && _a !== void 0 ? _a : routes[newUri];\n        if (!componentHtml)\n            componentHtml = Error404_1.default;\n        content.innerHTML = yield componentHtml.render();\n        if (componentHtml && componentHtml.action) {\n            componentHtml.action();\n        }\n    });\n};\nexports[\"default\"] = loadPageHtml;\n\n\n//# sourceURL=webpack://mickeyf.org/./src/helpers/loadPage.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst methods_1 = __webpack_require__(/*! ../helpers/methods */ \"./src/helpers/methods.ts\");\nfunction listUsers() {\n    return {\n        data: [],\n        list: function () {\n            try {\n                (0, methods_1.getUserData)().then(data => {\n                    this.data = data;\n                });\n            }\n            catch (error) {\n                console.log(error);\n            }\n        }\n    };\n}\nexports[\"default\"] = listUsers;\n\n\n//# sourceURL=webpack://mickeyf.org/./src/home/listUsers.ts?");
